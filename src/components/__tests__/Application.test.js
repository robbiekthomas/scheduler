...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for Monday by 1", async () => {
    ...
    // 4. Add the new appointment information
    ...
    // 6. Check to see if document is saving
    expect(getByText(appointment, "Saving")).toBeInTheDocument();

    // 7. Make sure the document updated with the new appointment
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    const confirm = getByText(appointment, "Confirm");

    fireEvent.click(queryByText(confirm, "Confirm"));
  ...
  it("loads data, edits an interview and increases the spots remaining for Monday the same", async () => {
    // 1. Render the Application.
    const { container, debug } = render(<Application />);
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    // 7. Make the document reject the new appointment
